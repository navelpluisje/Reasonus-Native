#include "action_fp_v2_setting_momentary_mute_solo.hpp"
#include <mini/ini.h>
...
namespace ACTION_FP_V2_SETTING_MOMENTARY_MUTE_SOLO {
    // some global non-const variables
    // the necessary 'evil'
    int command_id{0};
    bool toggle_action_state{false};
    constexpr auto command_name = "REASONUS_FPV2_TOGGLE_MOMENTARY_MUTE_SOLO";
    constexpr auto action_name = "Reasonus: v2 Toggle momentary mute/solo setting";
