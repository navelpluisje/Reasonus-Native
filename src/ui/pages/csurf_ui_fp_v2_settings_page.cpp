...
class CSurf_FP_V2_SettingsPage : public CSurf_UI_PageContent { // NOLINT(*-use-internal-linkage)
...
public:
    ...
    void Reset() override {
        ...
        index = std::find(latch_preview_action_indexes.begin(), latch_preview_action_indexes.end(),
