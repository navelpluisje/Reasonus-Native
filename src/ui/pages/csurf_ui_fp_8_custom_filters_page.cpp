...
class CSurf_FP_8_CustomFiltersPage : public CSurf_UI_PageContent {
    ...
    std::vector<int> filter_colors;
    ReaSonusFilterListBox *filters_list = nullptr;
...
public:
    CSurf_FP_8_CustomFiltersPage(ImGui_Context *m_ctx, CSurf_UI_Assets *assets)
        ...
        filters_list = new ReaSonusFilterListBox(
            m_ctx,
            assets,
            "filters",
            filter_labels,
