        ...
        if (ImGui::BeginChild(m_ctx, "main_about_page", 0.0, 0.0, ImGui::ChildFlags_None)) {
            ...
            if (ImGui::BeginChild(m_ctx, "filter_content", 0.0, 0.0)) {
                ...
                if (ImGui::BeginChild(m_ctx, "Contribute & Links", 0.0, device != FP_V2 ? 292.0 : 0.0,
                    ...
                    ImGui::Text(m_ctx, ", or ");
                    ImGui::SameLine(m_ctx);
                    ImGui::TextLinkOpenURL(m_ctx, i18n->t("about", "contribute.link.tipeee").c_str(),
                                           "https://en.tipeee.com/navelpluisje");
                    ...
                    ImGui::TextLinkOpenURL(m_ctx, i18n->t("about", "contribute.link.bug").c_str(),
                                           "https://github.com/navelpluisje/Reasonus-Native/issues");
                    ImGui::SameLine(m_ctx);
                    ImGui::Text(m_ctx, ", or ");
                    ImGui::SameLine(m_ctx);
                    ImGui::TextLinkOpenURL(m_ctx, i18n->t("about", "contribute.link.question").c_str(),
