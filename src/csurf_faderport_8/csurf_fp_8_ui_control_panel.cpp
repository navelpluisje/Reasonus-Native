...
ReaSonus8ControlPanel::ReaSonus8ControlPanel()
    : m_ctx{}
{
    menu_items.push_back(i18n->t("control-panel.menu.functions"));
    menu_items.push_back(i18n->t("control-panel.menu.filters"));
    menu_items.push_back(i18n->t("control-panel.menu.plugin"));
    menu_items.push_back(i18n->t("control-panel.menu.settings"));
    menu_items.push_back(i18n->t("control-panel.menu.about"));
